...
Generate differential diagnoses as JSON array.`,
        ...
        const uncResp = await fetch(uncUrl, {
          ...
          body: JSON.stringify({
            ...
            differential_diagnoses: (modularOutput.ddx?.differential_diagnoses || modularOutput.hypotheses || []).map((d: any) => ({
              ...
              symptom_coverage: d.symptom_coverage || "",
            })),
            ...
            evidence_citations: modularOutput.evidence || modularOutput.pubmed_citations || [],
            dangerous_diagnoses: modularOutput.ddx?.dangerous_diagnoses || [],
    ...
    return new Response(JSON.stringify({
      ...
      modular_pipeline: {
        ...
        uncertainty: modularOutput.uncertainty || null,
