  ...
  <footer className="bg-dark border-t border-border/10">
    <div className="container mx-auto px-4 py-10 flex flex-col md:flex-row justify-between items-center gap-5">
      <Link to="/" className="font-display font-extrabold text-xl text-dark-foreground">
        <span className="text-primary">DATA</span><span className="text-dark-foreground">elix</span><span className="text-primary">AI</span><span className="text-dark-foreground">r</span>
      </Link>
      <div className="flex gap-7 flex-wrap justify-center">
        {["About", "Services", "Blog", "Contact", "Privacy Policy", "Terms"].map((l) => (
          <Link
            key={l}
