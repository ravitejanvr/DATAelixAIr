...
const ENGINE_FIELD_CONSUMPTION: Record<PipelineStage, readonly string[]> = {
  ...
  evidence: ["chief_complaint"],
  bayesian: ["symptoms", "patient_age", "patient_sex", "medical_history", "vitals.temperature", "vitals.spo2", "vitals.pulse"],
  guideline: ["chief_complaint", "current_medications"],
  hypothesis: ["chief_complaint", "symptoms", "associated_symptoms", "symptom_duration", "medical_history", "current_medications", "allergies", "patient_age", "patient_sex", "vitals.temperature", "vitals.spo2", "vitals.pulse", "vitals.bp_systolic", "vitals.bp_diastolic", "vitals.respiratory_rate", "vitals.weight_kg", "vitals.height_cm"],
  safety: ["current_medications", "allergies", "risk_flags"],
  uncertainty: ["symptoms", "medical_history", "current_medications", "allergies", "vitals.temperature", "vitals.spo2", "vitals.pulse", "vitals.bp_systolic"],
  soap: ["chief_complaint", "symptoms", "associated_symptoms", "symptom_duration", "medical_history", "family_history", "current_medications", "allergies", "vitals.bp_systolic", "vitals.bp_diastolic", "vitals.pulse", "vitals.temperature", "vitals.spo2", "vitals.respiratory_rate", "vitals.weight_kg", "vitals.height_cm", "lab_results", "risk_factors"],
