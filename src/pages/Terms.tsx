...
const Terms = () => (
  <div className="container mx-auto px-4 py-24 max-w-3xl">
    <SEO title="Terms of Use — DATAelixAIr™ by elixAIr" description="Terms and conditions for using the DATAelixAIr™ AI clinical workspace, developed by elixAIr." noindex />
